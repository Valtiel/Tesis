                    ...
                    <div class="row-fluid">
                        <div class="span8">
                            <form class="form-horizontal">
                                <fieldset>
                                    <legend>Editar Institucion</legend>
                        ...
                        <div class="span4">
                            <div class="media well">
                                ...
                                <div class="media-body">
                                    <h4 class="media-heading">Editar Institucion</h4>
                                    Llena el siguiente formulario para poder editar una institucion,
                                    Recuerde que el ID debe coincidir para que la edicion sea exitosa. 
                                </div>
                            </div>
